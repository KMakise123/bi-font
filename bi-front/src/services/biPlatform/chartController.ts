...
/** genChartAsyncByAi POST /api/chart/gen/async/mq */
...
/** genChartAsyncByThread POST /api/chart/gen/async/thread */
export async function genChartAsyncByThreadUsingPost(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.genChartAsyncByThreadUsingPOSTParams,
  body: {},
  file?: File,
  options?: { [key: string]: any },
) {
  ...
  return request<API.BaseResponseBiResponse_>('/api/chart/gen/async/thread', {
    method: 'POST',
    params: {
      ...params,
    },
...
/** listChartByPageVo POST /api/chart/list/page/vo */
export async function listChartByPageVoUsingPost(
  body: API.ChartQueryRequest,
  options?: { [key: string]: any },
) {
